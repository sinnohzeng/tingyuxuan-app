...
- [Phase 7: Windows 语音 MVP 修复与重构（历史里程碑）](plan/phase-7-voice-mvp-remediation.md)

Sprint 实施计划（`YYYY-MM-DD-topic.md`）：具体任务级别的实施方案。

- [v0.10.3 技术债修复与文档同步执行计划（当前执行 SSOT）](plan/2026-03-03-technical-debt-remediation-v0.10.3.md)
...
- 不在多处重复同一信息，而是互相引用
- 当前执行计划唯一真值：`docs/plan/2026-03-03-technical-debt-remediation-v0.10.3.md`
- 若历史 Phase 文档与当前执行计划冲突，以当前 SSOT 计划为准（历史文档仅用于追溯）
